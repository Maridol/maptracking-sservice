"""
Django settings for maptracking_main project on Heroku. For more info, see:
...
ROOT_URLCONF = 'maptracking_main.urls'
...
WSGI_APPLICATION = 'maptracking_main.wsgi.application'
